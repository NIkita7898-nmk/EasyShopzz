...
def checkout(request):
    ...
    return render(request, 'app/checkout.html', {'add':add, 'total_amount': total_amount, 'cart_items':cart_item})
...
class ProfileView(View):
    ...
    def post(self, request):
        ...
        if form.is_valid():
            ...
            reg.save()
            messages.success(request, 'Congrtulations!! Profile updated successfully')
        return render(request, 'app/profile.html', {'form':form, 'active':'btn-primary'})
